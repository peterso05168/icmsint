...
import hk.judiciary.icmsint.model.sysinf.converter.gfpid2j.FixedPenaltyNoticeOfOrderV20CT_SysInfCaseDTO_Converter;
...
public class FixedPenaltyNoticeOfOrderApplicationHandler extends BaseGFPIMsgHandler {
	
	public FixedPenaltyNoticeOfOrderApplicationHandler(
			JudiciaryUser judiciaryUser,
			String partyCd) {
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GFPI_D2J_FIXED_PENALTY_NOTICE_OF_ORDER_APPLICATION, SysInfConstant.SYSINF_MSG_TYPE_CD_GFPI, SysInfConstant.SYSINF_MSG_MSGNAT_IN);
	}
	...
	public CommonWsDTO handleMsg(GFPIMsgD2J msg) throws SysInfHandlerException {
		int seqNo = 0;
        int failCnt = 0;
        for (FixedPenaltyNoticeOfOrderV20CT fixedPenaltyNoticeOfOrder : msg.getFixedPenaltyNoticeOfOrder()) {
			try {
				FixedPenaltyNoticeOfOrderV20CT_SysInfCaseDTO_Converter converter = new FixedPenaltyNoticeOfOrderV20CT_SysInfCaseDTO_Converter();
	        	SysInfCaseDTO sysInfCaseDto = converter.convert(fixedPenaltyNoticeOfOrder);
	        	String fileName = genFileName(fixedPenaltyNoticeOfOrder);
				...
				try {
					...
					insertSysInfErr(insertSysInfRec(seqNo++, genFileName(fixedPenaltyNoticeOfOrder), SysInfStatus.FAIL.code()), errMsg);
	...
	private String genFileName(FixedPenaltyNoticeOfOrderV20CT fixedPenaltyNoticeOfOrder) {
