...
@XmlSeeAlso({
    ...
    NoticeOfOrderCourtResultTypeV10CT.class,
    ...
    ReceiptStatusV10CT.class,
    FixedPenaltySummonsCourtResultTypeV10CT.class,
    NoticeOfOrderCourtResultCodeV10CT.class,
    DICTypeV10CT.class,
    NoticeOfOrderCourtResultCodeV101CT.class,
    DepartmentReferenceNumberV10CT.class,
    PaymentCentreV10CT.class,
    PaymentMethodV10CT.class,
    PrefixV11CT.class,
    FixedPenaltyCostsCodeV10CT.class,
    ProsecutionDepartmentUnitV10CT.class,
    HearingTypeV10CT.class,
    FixedPenaltySummonsCourtResultCodeV10CT.class,
    HearingMagistrateCodeV10CT.class,
    OffenceDateFormatV10CT.class,
    RelationshipCodeV10CT.class,
    FixedPenaltySummonsCourtResultCodeV101CT.class,
    DICTypeV11CT.class,
