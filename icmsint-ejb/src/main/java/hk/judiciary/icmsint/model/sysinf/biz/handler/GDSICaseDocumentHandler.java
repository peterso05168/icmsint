...
import hk.judiciary.icmsint.model.sysinf.converter.gdsnid2j.CaseDocumentV10CT_SysInfCaseDTO_Converter;
...
public class GDSICaseDocumentHandler extends BaseGDSNIMsgHandler {
	
	public GDSICaseDocumentHandler(JudiciaryUser judiciaryUser, String partyCd) {
