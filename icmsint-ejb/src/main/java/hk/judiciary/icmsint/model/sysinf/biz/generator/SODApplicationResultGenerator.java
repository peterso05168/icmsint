...
public class SODApplicationResultGenerator extends BaseGDSNIMsgGenerator {
	
	public SODApplicationResultGenerator(JudiciaryUser judiciaryUser, String partyCd, 
			SysInfCtrlDAO sysInfCtrlDao, SysInfCtrlTypeDAO sysInfCtrlTypeDao, PdDAO pdDao) {
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GDSNI_J2D_SOD_APPLICATION_RESULT, ControlService.SYSINF_CTRL_TYPE_CD_CASE_ALLOCATION, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
