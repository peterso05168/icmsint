...
/**
 * court order results for the Fixed Penalty Notice of Order.
 *                                  Message consists of
 * 								a) Record Prefix
 ...
 * 			
 * 
 * <p>FixedPenaltyNoticeOfOrderCourtResult.V2.0.CT complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="FixedPenaltyNoticeOfOrderCourtResult.V2.0.CT">
 *   &lt;complexContent>
...
@XmlType(name = "FixedPenaltyNoticeOfOrderCourtResult.V2.0.CT", propOrder = {
    "recordPrefix",
    "caseNumber",
    "demandNoteNumber",
...
public class FixedPenaltyNoticeOfOrderCourtResultV20CT {
