...
public class SummonsHearingResultGenerator extends BaseGDSNIMsgGenerator {
	
	public SummonsHearingResultGenerator(JudiciaryUser judiciaryUser, String partyCd, 
			SysInfCtrlDAO sysInfCtrlDao, SysInfCtrlTypeDAO sysInfCtrlTypeDao, PdDAO pdDao) {
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GDSNI_J2D_SUMMON_HEARING_RESULT, ControlService.SYSINF_CTRL_TYPE_CD_SUMMON_HEARING_RESULT, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
