...
public class GDSNIPaymentUpdateGenerator extends BaseGDSNIMsgGenerator {
	
	public GDSNIPaymentUpdateGenerator(JudiciaryUser judiciaryUser, String partyCd, 
			SysInfCtrlDAO sysInfCtrlDao, SysInfCtrlTypeDAO sysInfCtrlTypeDao, PdDAO pdDao) {
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GDSNI_J2D_COURT_PAYMENT, ControlService.SYSINF_CTRL_TYPE_CD_PAYMENT_UPDATE, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
