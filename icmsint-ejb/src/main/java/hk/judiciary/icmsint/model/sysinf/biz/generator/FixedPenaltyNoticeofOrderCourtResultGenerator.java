...
public class FixedPenaltyNoticeofOrderCourtResultGenerator extends BaseGFPIMsgGenerator {
	
	public FixedPenaltyNoticeofOrderCourtResultGenerator(JudiciaryUser judiciaryUser, String partyCd, 
		...
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GFPI_J2D_FIXED_PENALTY_NOTICE_OF_ORDER_COURT_RESULT, ControlService.SYSINF_CTRL_TYPE_CD_FIXED_PENALTY_NOTICE_OF_ORDER_COURT_RESULT, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
