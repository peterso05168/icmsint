 ...
 *                                r) Apply to Fixed Penalty Summons Indicator
 *             
 * 
 * <p>CSOD.V1.0.CT complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CSOD.V1.0.CT">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ShortDescriptionChinese" type="{}ShortDescriptionChinese.V1.0.CT"/>
 *         &lt;element name="LongDescription" type="{}OffenceDescription.V1.0.CT"/>
 *         &lt;element name="LongDescriptionChinese" type="{}OffenceDescriptionChinese.V1.0.CT"/>
 *         &lt;element name="Law" type="{}Law.V1.0.CT"/>
 *         &lt;element name="LawChinese" type="{}LawChinese.V1.0.CT"/>
 *         &lt;element name="AttachmentIndicator" type="{}FieldIndicator.V1.0.CT" minOccurs="0"/>
 *         &lt;element name="HearingWeight" type="{}HearingWeight.V1.0.CT" minOccurs="0"/>
 *         &lt;element name="PenaltyWeight" type="{}PenaltyWeight.V1.0.CT" minOccurs="0"/>
 ...
 *         &lt;element name="ApplyToFixedPenaltySummons" type="{}FieldIndicator.V1.0.CT" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CSOD.V1.0.CT", propOrder = {
    "sodKey",
    ...
    "timeBarOffence",
    "timeBarDiscover",
    "applyToFixedPenaltySummons"
})
public class CSODV10CT {
    ...
    protected OffenceDescriptionChineseV10CT longDescriptionChinese;
    ...
    @XmlElement(name = "HearingWeight")
    protected HearingWeightV10CT hearingWeight;
    @XmlElement(name = "PenaltyWeight")
    ...
    @XmlElement(name = "ApplyToFixedPenaltySummons")
    protected FieldIndicatorV10CT applyToFixedPenaltySummons;
     ...
     *     
     */
    public OffenceDescriptionChineseV10CT getLongDescriptionChinese() {
     ...
     *     
     */
    public void setLongDescriptionChinese(OffenceDescriptionChineseV10CT value) {
    ...
    /**
     * 获取applyToFixedPenaltySummons属性的值。
     * 
     * @return
     *     possible object is
     *     {@link FieldIndicatorV10CT }
     *     
     */
    public FieldIndicatorV10CT getApplyToFixedPenaltySummons() {
        return applyToFixedPenaltySummons;
    }

    /**
     * 设置applyToFixedPenaltySummons属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link FieldIndicatorV10CT }
     *     
     */
    public void setApplyToFixedPenaltySummons(FieldIndicatorV10CT value) {
        this.applyToFixedPenaltySummons = value;
    }
