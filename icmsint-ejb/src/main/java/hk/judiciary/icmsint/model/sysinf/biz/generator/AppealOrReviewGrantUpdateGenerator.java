...
public class AppealOrReviewGrantUpdateGenerator extends BaseGDSNIMsgGenerator {
	
	public AppealOrReviewGrantUpdateGenerator(JudiciaryUser judiciaryUser, String partyCd, 
