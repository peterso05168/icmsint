...
import hk.judiciary.icmsint.model.sysinf.biz.generator.GDSNIWarrantStatusUpdateGenerator;
...
public class WarrantBO extends BaseBO {
	...
	public GDSNIMsgDTO GDSNIMsgJ2D_CM_GI05(JudiciaryUser user,String partyCd) throws Exception {
		GxxiMsgGenerator gxxiMsgGenerator = new GDSNIWarrantStatusUpdateGenerator(user, partyCd, getSysInfCtrlDAO(), getSysInfCtrlTypeDAO(), getPdDAO());
