...
public class WarrantStatusChangeGenerator extends BaseGFPIMsgGenerator {
	
	public WarrantStatusChangeGenerator(JudiciaryUser judiciaryUser, String partyCd, 
			SysInfCtrlDAO sysInfCtrlDao, SysInfCtrlTypeDAO sysInfCtrlTypeDao, PdDAO pdDao) {
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GFPI_J2D_WARRANT_STATUS_CHANGE, ControlService.SYSINF_CTRL_TYPE_CD_WARRANT_STATUS_CHANGE, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
