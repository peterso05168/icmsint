...
@XmlSeeAlso({
    ...
    ReceiptNumberV10CT.class,
    DemandNoteNumberV11CT.class,
    ParagraphV11CT.class,
    CommittalWritNumberV11CT.class,
    ...
    SectionV10CT.class,
    PaymentCodeV10CT.class,
    InterfaceIDV10CT.class,
    RollbackFromStateV10CT.class,
    ...
    CommittalWritNumberV10CT.class,
