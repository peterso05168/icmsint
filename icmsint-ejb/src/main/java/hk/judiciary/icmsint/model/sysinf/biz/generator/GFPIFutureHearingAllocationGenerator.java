...
public class GFPIFutureHearingAllocationGenerator extends BaseGFPIMsgGenerator {
	
	public GFPIFutureHearingAllocationGenerator(JudiciaryUser judiciaryUser, String partyCd, 
