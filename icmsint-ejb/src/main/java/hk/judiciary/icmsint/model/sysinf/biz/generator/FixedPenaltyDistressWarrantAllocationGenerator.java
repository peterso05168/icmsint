...
public class FixedPenaltyDistressWarrantAllocationGenerator extends BaseGFPIMsgGenerator {
	
	public FixedPenaltyDistressWarrantAllocationGenerator(JudiciaryUser judiciaryUser, String partyCd, 
		...
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GFPI_J2D_FIXED_PENALTY_DISTRESS_WARRANT_ALLOCATION, ControlService.SYSINF_CTRL_TYPE_CD_FIXED_PENALTY_DISTRESS_WARRANT_ALLOCATION, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
