 ...
 *         &lt;choice>
 *           &lt;element name="NoticeOfOrderApplication" type="{}DeptNoticeOfOrder.V2.0.CT" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "GDSNIMsgD2J")
public class GDSNIMsgD2J {

    @XmlElement(name = "InterfaceFileHeader", required = true)
    protected InterfaceFileHeaderV13CT interfaceFileHeader;
    @XmlElement(name = "NoticeOfOrderApplication")
    protected List<DeptNoticeOfOrderV20CT> noticeOfOrderApplication;
    ...
    /**
     * Gets the value of the noticeOfOrderApplication property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the noticeOfOrderApplication property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNoticeOfOrderApplication().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DeptNoticeOfOrderV20CT }
     * 
     * 
     */
    public List<DeptNoticeOfOrderV20CT> getNoticeOfOrderApplication() {
        if (noticeOfOrderApplication == null) {
            noticeOfOrderApplication = new ArrayList<DeptNoticeOfOrderV20CT>();
        }
        return this.noticeOfOrderApplication;
    }
