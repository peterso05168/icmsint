...
public class AppealReviewGrantGenerator extends BaseGFPIMsgGenerator {
	
	public AppealReviewGrantGenerator(JudiciaryUser judiciaryUser, String partyCd, 
		...
		super(judiciaryUser, partyCd, SysInfConstant.SYSINF_MSG_CD_GFPI_J2D_APPEAL_REVIEW_GRANT, ControlService.SYSINF_CTRL_TYPE_CD_APPEAL_REVIEW_GRANT, sysInfCtrlDao, sysInfCtrlTypeDao, pdDao);
	}
