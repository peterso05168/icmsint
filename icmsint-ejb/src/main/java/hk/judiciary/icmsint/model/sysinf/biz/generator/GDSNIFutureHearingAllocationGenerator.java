...
public class GDSNIFutureHearingAllocationGenerator extends BaseGDSNIMsgGenerator {
	
	public GDSNIFutureHearingAllocationGenerator(JudiciaryUser judiciaryUser, String partyCd, 
